...
void QuadShow(uint8_t show_enable)
{
  uint16_t i=0;
	...
	if(Pitch_Control>=25)
	{
		if(chioce==1) {Total_Controller.Optical_Speed_Control.Kp+=0.2;	}
		if(chioce==2) {Total_Controller.Optical_Speed_Control.Ki+=0.005;	}
		if(chioce==3) {Total_Controller.Optical_Speed_Control.Kd+=0.1;	}
		if(chioce==4) {Total_Controller.Pitch_Angle_Control.Kp+=1;	}
		LCD_CLS();
	}
	  ...
	  LCD_clear_L(0,1);  LCD_P6x8Str(0,1,"Kp:");            					write_6_8_number(40,1,Total_Controller.Optical_Speed_Control.Kp);  
		LCD_clear_L(0,2);  LCD_P6x8Str(0,2,"Ki:");          					write_6_8_number(40,2,Total_Controller.Optical_Speed_Control.Ki);                                    
		LCD_clear_L(0,3);  LCD_P6x8Str(0,3,"Kd:");           					write_6_8_number(40,3,Total_Controller.Optical_Speed_Control.Kd);  
		LCD_clear_L(0,4);  LCD_P6x8Str(0,4,"Kd_a:");           					write_6_8_number(40,4,Total_Controller.Pitch_Angle_Control.Kp);  
		...
		else if(Page_Number==0)
		{
			...
			LCD_clear_L(0,4);  LCD_P6x8Str(0,4,"Baro:");           					write_6_8_number(40,4,(uint32_t)(WP_Sensor.baro_pressure_raw));    
